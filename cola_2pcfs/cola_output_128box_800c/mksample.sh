...
#LSS_SnapshotRSDmock -input ${nowfile_par}  -xyzmin 0 -xyzmax 1024 -xcol 1 -ycol 2 -zcol 3 -vxcol 4 -vycol 5 -vzcol 6 -redshift 0 -omegam ${om} -w -1 -shiftx T -shifty T -shiftz T -shiftr T
...
ranfile=${nowfile_degraded}.x15ran0
py_ran ${ranfile} $((${ngal}*15)) 256 box 1w
#ranfile=${nowfile}.x30ran0
#py_ran ${ranfile} $((${nline}*30)) 1024 box 1w
#ranfile=${nowfile}.x30ran0
#py_ran ${ranfile} $((${npar}*30)) 1024 box 1w
